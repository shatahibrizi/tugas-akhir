        ...
        <div class="card card-equal-height">
          <div class="card-body card-body-equal-height p-3">
            <div class="row">
              <div class="col-8">
                <div class="numbers">
                  <p class="text-capitalize font-weight-bold mb-0 text-sm">Total Jumlah Pembeli</p>
                  <h5 class="font-weight-bolder mb-0">
                    {{ $totalCustomers }}
                    <span class="text-success font-weight-bolder text-sm">+{{ round($customerGrowthPercentage) }}%</span>
                  </h5>
                </div>
              </div>
              <div class="col-4 text-end">
            ...
            <div class="row">
              <div class="col-8">
                <div class="numbers">
                  ...
                  <h5 class="font-weight-bolder mb-0">
                    {{ $totalProducts }}
                    <span class="text-danger font-weight-bolder text-sm">-{{ round($productDecreasePercentage) }}%</span>
                  </h5>
                </div>
              </div>
              <div class="col-4 text-end">
