      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center pb-0">
            <h6>Produk Masuk</h6>
            <a href="{{ route('admin.produkMasuk.export') }}" class="btn btn-success">Ekspor ke Excel</a>
          </div>
                  ...
                  <tbody>
                    @foreach ($tambahProduk as $item)
                      <tr>
                        ...
                        <td class="text-center align-middle">
                          <span class="text-secondary font-weight-bold text-sm">{{ $item->pengepul_nama }}</span>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
