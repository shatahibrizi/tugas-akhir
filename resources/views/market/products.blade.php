      ...
      <div class="row g-4">
        <div class="col-lg-12">
          <div class="row g-4">
            ...
            <div class="col-6"></div>
            <div class="col-xl-3">
              <div class="bg-light d-flex justify-content-between mb-4 rounded py-3 ps-3">
                <label for="fruits">Default Sorting:</label>
                <select id="fruits" name="fruitlist" class="form-select-sm bg-light me-3 border-0" form="fruitform">
              ...
              <div class="row g-4">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="d-flex align-items-center justify-content-start">
                    <div class="me-4 rounded" style="width: 100px; height: 100px;">
                  ...
                  <div class="d-flex justify-content-center my-4">
                    <a href="#" class="btn border-secondary rounded-pill text-primary w-100 border px-4 py-3">Vew
                      More</a>
                  </div>
                </div>
                <div class="col-lg-12">
