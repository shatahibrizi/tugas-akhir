      ...
      <div class="col-lg-5">
        <div class="card card-carousel h-100 overflow-hidden p-0">
          <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
            ...
            <button class="carousel-control-prev me-3 w-5" type="button" data-bs-target="#carouselExampleCaptions"
              data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next me-3 w-5" type="button" data-bs-target="#carouselExampleCaptions"
              data-bs-slide="next">
